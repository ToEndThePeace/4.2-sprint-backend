...
Relational Databases are a data model that is queried using SQL.

- [ ] Why do tables need a `primary key`?

Primary keys are used to identify certain row in a table. They are unique and indexed.
...
In order to have a many-to-many relationship between two tables, a third table must be created with foreign keys to each of the other referenced tables.
